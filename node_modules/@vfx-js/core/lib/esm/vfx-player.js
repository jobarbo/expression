...
import { createRect, getIntersection, growRect, RECT_ZERO, } from "./rect.js";
...
export class VFXPlayer {
    constructor(canvas, pixelRatio) {
        ...
        _VFXPlayer_playLoop.set(this, () => {
            ...
            for (const e of __classPrivateFieldGet(this, _VFXPlayer_elements, "f")) {
                ...
                const logicalViewport = growRect(__classPrivateFieldGet(this, _VFXPlayer_viewport, "f"), e.intersection.rootMargin);
    ...
    addElement(element_1) {
        return __awaiter(this, arguments, void 0, function* (element, opts = {}) {
            ...
            const logicalViewport = growRect(__classPrivateFieldGet(this, _VFXPlayer_viewport, "f"), intersectionOpts.rootMargin);
            const intersection = getIntersection(__classPrivateFieldGet(this, _VFXPlayer_viewport, "f"), rect);
...
export function parseIntersectionOpts(intersectionOpts) {
    ...
    const rootMargin = createRect((_b = intersectionOpts === null || intersectionOpts === void 0 ? void 0 : intersectionOpts.rootMargin) !== null && _b !== void 0 ? _b : 0);
    return {
        threshold,
        rootMargin,
    };
